...
-export([on_client_connected/3, on_client_disconnected/4, on_client_authenticate/3, on_client_check_acl/5]).
...
on_client_connected(_ConnectInfo = #{clientid := ClientId, username := Username}, ConnInfo, _Env) ->
...
on_client_disconnected(_DisconnectInfo = #{clientid := ClientId, username := Username}, Reason, ConnInfo, _Env) ->
